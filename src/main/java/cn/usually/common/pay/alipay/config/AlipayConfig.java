package cn.usually.common.pay.alipay.config;
...
public class AlipayConfig {
	...
	// 合作者身份ID
	private static String partner = ""; // 合作者身份ID:从支付宝账户配置文件中获取
	// 商户的私钥
    public static String private_key = ""; // 开发者pacs8私钥:从支付宝账户配置文件中获取
	// 支付宝的公钥，无需修改该值
	public static String ali_public_key  = ""; // 支付宝公钥:从支付宝账户配置文件中获取
