...
//	private CommonPayService commonPayService;
	...
	public void dealRedirect(String buy_order_id, HttpServletRequest req, HttpServletResponse res, CheckInfo checkInfo) {
		...
		if(easy_empolyee_order != null) {
			...
			String openId = "";
			String URL = ConfigUtil.OAUTH2_OPENID_URL + "appid=" + ConfigUtil.APPID
					+ "&secret=" + ConfigUtil.APP_SECRECT + "&code=" + code
...
//			String device_info = "";
			...
			// 商品描述根据情况修改
			String body = ConfigUtil.MCH_NAME;
			// 附加数据
			String attach = "";
			// 总金额以分为单位，不带小数点
			...
			String notify_url = ConstantUrl.URL_WECHAT_REDIRECT;
			...
			wechatPageInfo.setAppid(ConfigUtil.APPID);
...
//			wechatPageInfo.setPrepay_id(prepay_id);
			...
			req.setAttribute("front_url", ConstantUrl.URL_WECHAT_REDIRECT);
		}
	}
