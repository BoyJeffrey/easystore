...
import com.yimin.easystore.wechat.constant.*;
...
public class WeChatSignatureUtil {
     ...
     * @return
     */
    public static boolean checkSubscribeSignature(String signature, String timestamp, String nonce,String token) {
    ...
    public static WeChatJsConfig jsSignature( String url,String jsTicket) {
        WeChatJsConfig jsConfig = new WeChatJsConfig();
        String nonce_str = WeChatConst.WECHAT_JS_NONCE;
